...
public class MainC extends JPanel implements ActionListener, MouseListener, MouseMotionListener{
	...
	//TODO FINISH LEFTIES ZONES AND MODIFY RIGHTIES ZONES and figure out why lefty zomes won't fill in
	private int clx;
	private int cly;
	private int mx;
	private int my;
	...
	private boolean wr3;
	private boolean wr4;
	private boolean wr1n;
	private boolean wr2n;
	private boolean wr3n;
	private boolean wr4n;
	private boolean wl0;
	private boolean wl1;
	private boolean wl2;
	private boolean wl3;
	private boolean wl4;
	private boolean wl1n;
	private boolean wl2n;
	private boolean wl3n;
	private boolean wl4n;
	private boolean wC4;
	private boolean wC3;
	private boolean wC2;
	private boolean wC1;
	private boolean wC0;
	private boolean wC4n;
	private boolean wC3n;
	private boolean wC2n;
	private boolean wC1n;
	private boolean wO4;
	private boolean wO3;
	private boolean wO2;
	private boolean wO1;
	private boolean wO0;
	private boolean wO4n;
	private boolean wO3n;
	private boolean wO2n;
	private boolean wO1n;
	private boolean  C4;
	private boolean  C3;
	private boolean  C2;
	private boolean  C1;
	...
	private boolean  O2n;
	private boolean  O1n;
	private boolean wlc0;
	private boolean wlc1;
	private boolean wlc2;
	private boolean wlc3;
	private boolean wlc4;
	private boolean wlc1n;
	private boolean wlc2n;
	private boolean wlc3n;
	private boolean wlc4n;
	private boolean wlo0;
	private boolean wlo1;
	private boolean wlo2;
	private boolean wlo3;
	private boolean wlo4;
	private boolean wlo1n;
	private boolean wlo2n;
	private boolean wlo3n;
	private boolean wlo4n;
	
	//info about pitches
	private int EVfactor;
	private int ppEVfactor;
	private int fBSpeed;
	...
	private boolean wasOS = true;
	private boolean showFB;
	private boolean showCU;
	private boolean showOS;
	private boolean hiLiFB;
	private boolean hiLiCU;
	private boolean hiLiOS;
	private boolean showFBL;
	private boolean showCUL;
	private boolean showOSL;
	private boolean hiLiFBL;
	private boolean hiLiCUL;
	private boolean hiLiOSL;
	private JLabel pitchLbl = new JLabel("Pitch:    ");
	private JLabel previousPitchLbl = new JLabel("PP: ");
	...
	public MainC(){
		...
		gr.weightx = .2; gr.weighty = 1; gr.anchor = gr.LINE_START; 
	...
	//	gr.weightx = .8; gr.weighty = 1;
		...
		gb.weightx = .2; gb.weighty = 1; gb.anchor = gb.LINE_START;
		...
		gb.weightx = .2; gb.weighty = 1; gb.anchor = gb.LINE_END;
		...
		if(wH == true){
			...
			if(my > 19*getHeight()/20 && mx > getWidth() /5){
				if(mx < 2 * getWidth() / 5){
					...
					cU.setForeground(new Color(255,152,0,52));
					oS.setForeground(new Color(255,152,0,52));
					hiLiFBL = true; hiLiCUL = false; hiLiOSL = false;
				}
				else if(mx < 3*getWidth()/5){
					cU.setForeground(Color.red);
					fB.setForeground(new Color(255,152,0,52));
					oS.setForeground(new Color(255,152,0,52));
					hiLiFBL = false; hiLiCUL = true; hiLiOSL = false;
				}
				else if(mx < 4*getWidth()/5){
					oS.setForeground(Color.red);
					fB.setForeground(new Color(255,152,0,52));
					cU.setForeground(new Color(255,152,0,52));
					hiLiFBL = false; hiLiCUL = false; hiLiOSL = true;
				}
			}
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == fastB){
			...
			bTP.setVisible(false);
			wasFB = false; wasOS = false; wasCU = true;
			fillInBoxes();
			ppEVfactor = EVfactor;
		}
